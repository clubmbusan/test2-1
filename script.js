...
document.addEventListener("click", function (event) {
    if (event.target.classList.contains("removeAssetButton")) {
        ...
        const selectedInheritanceType = document.querySelector("#inheritanceType")?.value;
        const selectedAssetType = document.querySelector(".assetType")?.value;
        ...
        // ✅ 기본적으로 열려 있어야 할 관계 입력 창(`personalSection`, `groupSection`) 유지
