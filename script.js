...
// ✅ 4. 배우자 제외 상속인의 상속 비율에 따라 "무조건 5억을 배분" (기존 방식 제거)
...
// ✅ 5. 남은 차액을 가장 높은 상속 금액을 가진 상속인에게 추가 배분
...
heirs = heirs.map(heir => {
    ...
    console.log(`   - 일괄공제:`, individualLumpSumExemption); // 🔥 수정 완료
