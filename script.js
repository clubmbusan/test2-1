 ...
 */
  function calculateRelationshipExemption(relationship, shareAmount) {
    ...
    const maxAdditionalExemption = 10000000000; // 추가 공제 최대 10억
    const maxSpecialExemption = 3500000000; // 특별 공제 최대 35억
